  ...
  return (
    <section className="chat_banner_area">
      <img
        ...
        src={require('../img/home/cloud.png')}
        alt=""
      />
      <img
        className="p_absoulte left wow fadeInLeft"
        data-wow-delay="0.2s"
        src={require('../img/home/left_leaf.png')} 
        alt=""
      />
      <img
        className="p_absoulte right wow fadeInRight"
        data-wow-delay="0.3s"
        src={require('../img/home/right_leaf.png')}
        alt=""
      />
          ...
          <div className="col-lg-6">
            <div className="chat_banner_content">
              <div className="c_tag wow fadeInUp">
                <img src={require("../img/home/live_chat.png")} alt="" /> Live chat
              </div>
          ...
          <div className="col-lg-4 offset-lg-2">
            <div className="chat_img">
              <img
                ...
                src={require('../img/home/panguin_img_one.png')}
                alt=""
              />
              <img
                className="p_absoulte p_two"
                src={require('../img/home/panguin_img_two.png')}
                alt=""
              />
              <img
                className="p_absoulte p_three"
                src={require('../img/home/panguin_img_three.png')}
                alt=""
              />
              ...
              <img
                ...
                data-wow-delay="0.2s"
                src={require('../img/home/Messages.png')}
                alt="chat-img"
              />
            </div>
          </div>
